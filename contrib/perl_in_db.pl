...
#cs_ident=2 <-<-< FAX
#cs_ident=1 <-<-< voice
#./script_name -caller 07551309861 -called 309861 -cs_user jonas -cs_ident 1 -cs_file /var/capisuite/fax/vouce.file -starttime 19:44:43
use DBI;
use MIME::Base64;
use Getopt::Long;
use Config::Simple;
...
my $sqlquery="INSERT INTO capisuite VALUES(NULL,'1',FROM_UNIXTIME($starttime),'$ident','$called','$caller','$cs_user','$lines')";
