/*
     copyright            : (C) 2002,2003 by Jonas Genannt only the modification.
     copyright 		  : (C) calle, look at capiconn.c and capiconn.h
 ...
 ***************************************************************************/
/*
Jonas Genannt <jonasge@gmx.net>
Orginal from calle    calle@calle.in-berlin.de
I
*/
