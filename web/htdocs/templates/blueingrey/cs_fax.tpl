...
<tr style="font-weight:bold;">
  ...
  <tr style="background-color:{tab1.tab2.DATA_COLOR}">
   ...
   <td><a href="cs_viewfax.php?file={tab1.tab2.DATA_CS_ID}"><img src="./images/view.png" style="border-width:0px;vertical-align:middle;" alt=""/></a></td>
  <!-- BEGIN delD -->
  <td style="text-align:center;"><a href="./cs_fax.php?del={tab1.tab2.delD.DATA_ID}"><img src="./images/edittrash.png" style="border-width:0px;vertical-align:middle;" alt=""/></a></td>
  <!-- END delD -->
  </tr>
  <!-- END tab2 -->
</table>
