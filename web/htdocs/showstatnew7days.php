...
if (isset($_GET[unbekannt]))
 {
 echo "<br /><form action=\"./showstatnew7days.php\" method=\"post\"><input type=\"hidden\" name=\"newid\" value=\"$_GET[einid]\">";
...
if (isset($_POST[eintragen]))
  {
   ...
   mysql_select_db($db);
   mysql_query("UPDATE angerufene SET name='$_POST[newname]' WHERE id=$_POST[newid]");
   mysql_close();
  }
...
<table border=\"0\" cellpadding=\"5\" cellspacing=\"2\">
 ...
 $tab_angerufene=mysql_query("SELECT * FROM angerufene WHERE datum='$tmp' ORDER BY 'id'  DESC");
  while($data=mysql_fetch_row($tab_angerufene))
   ...
   $tab_adressbuch = mysql_query("SELECT id,vorname,nachname,tele1,tele2,tele3,handy FROM adressbuch WHERE tele1='$data[1]' OR tele2='$data[1]' OR tele3='$data[1]' OR handy='$data[1]'");
   ...
   if ($adress_data==false)
    {
     ...
     $wertaddaddr=handynr_vorhanden($data[1]); 
      $anz_insaddr="<a href=\"./addadress.php?$wertaddaddr\"><CENTER><img src=\"./bilder/1rightarrow.gif\" BORDER=\"0\"></a></CENTER>";
      }
    $anz_name1=$anz_name;
...
$anz_statistik="<a href=\"./stat_anrufer.php?id=$adress_data[0]\" title=\"$textdata[showstatnew_zeige_anrufstat] $adress_data[1] $adress_data[2]\"><img  src=\"./bilder/data.png\" border=\"0\" align=\"middle\"></a>";
   ...
   <img src=\"./bilder/1leftarrow.gif\" BORDER=\"0\"></a>";
...
$anruf_loeschen="";
 ...
 if ($showtyp=="yes")
   { $anruftyp="<td style=\"text-align:center\">$anz_typ</td>"; }
 if ($showloeschen=="yes")
   { $anruf_loeschen="
      <td style=\"text-align:center\">
        <a href=\"./stat_loeschen.php?id=$data[0]\"  title=\"$textdata[showstatnew_loesche_db]\">
	<img src=\"./bilder/edittrash.png\" border=\"0\" align=\"middle\"></a>
	</td>"; 
   }
