...
<input type=\"submit\" name=\"aendern\" value=\"$textdata[editadress_eintrag_aendern]\"/></p>";
if (isset($_POST[loeschen_OK]) or $_GET[loeschen]==1)
 {
 echo "<p><input type=\"hidden\" name=\"loeschenID\" value=\"$id\"/>";
 echo "<input type=\"submit\" name=\"wloeschen\" value=\"$textdata[adressbuch_eintrag_loeschen]\"/></p>"; 
 }
else
 {
 
 echo "<p><input type=\"hidden\" name=\"loeschen_OK\" value=\"$id\"/>";
  echo "<input type=\"submit\" name=\"loeschen\" value=\"$textdata[adressbuch_eintrag_loeschen]\"/></p>";
 }  
