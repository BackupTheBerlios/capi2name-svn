...
<table border=\"0\" cellpadding=\"5\" cellspacing=\"2\">
  <tr>
   <td>$textdata[stat_anrufer_datum]</td>
   <td>$textdata[stat_anrufer_uhrzeit]</td>
   <td>$textdata[stat_anrufer_rufnummer]</td>
   <td>$textdata[stat_anrufer_MSN]</td>
  </tr>";
 ...
 while ($data_angerufene=mysql_fetch_array($result))
  ...
  if($i%2==0)
   ...
   <tr style=\"background-color:$color\">
    <td>$tmp</td>
	<td>$data_angerufene[uhrzeit]</td>
	<td>$data_angerufene[rufnummer]</td>
	<td>$data_angerufene[msn]</td></tr>";
   $i++;
  }
