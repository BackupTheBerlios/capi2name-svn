...
<tr>
 ...
 <input type="image" src="./images/1leftarrow.png" style="border:0px;background-color:#C8CECE;"/>
 </ins>
 </form>
 </td>
 ...
 <input type="hidden" value="{DATA_CUR_YEAR1}" name="jahr"/>
 <input type="image" src="./images/1rightarrow.png" style="border:0px;background-color:#C8CECE;"/>
 </ins>
 </form>
 </td>
</tr>
